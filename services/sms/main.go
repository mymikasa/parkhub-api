...
import (
	...
	"github.com/parkhub/api/services/sms/internal/config"
	smsgrpc "github.com/parkhub/api/services/sms/internal/grpc"
	"github.com/parkhub/api/services/sms/internal/health"
	"github.com/parkhub/api/services/sms/internal/middleware"
...
func main() {
	if err := run(); err != nil {
		fmt.Fprintf(os.Stderr, "parkhub-sms failed to start: %v\n", err)
		os.Exit(1)
	}
}
...
func run() error {
	...
	if err := db.AutoMigrate(&dao.SmsRecord{}); err != nil {
