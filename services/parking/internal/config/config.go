...
type Config struct {
	...
	IoTService IoTServiceConfig `yaml:"iot_service"`
...
func Default() Config {
	return Config{
		...
		IoTService: IoTServiceConfig{
			Address: "iot:50054",
		},
		Telemetry: TelemetryConfig{
			ServiceName: "parkhub-parking",
...
func applyEnvOverrides(cfg *Config) {
	...
	if v := os.Getenv("IOT_SERVICE_ADDR"); v != "" {
		cfg.IoTService.Address = v
	}
